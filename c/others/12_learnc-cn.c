...
int main() {
    ...
    */
    ...
    // 多重分支：switch()
    int some_integral_expression = 0;
    ...
    // 使用<limits.h>提供的CHAR_MAX、SCHAR_MAX和UCHAR_MAX宏可以确定`char`、`signed_char`和`unisigned
    // char`的最大值。 整数型和浮点型可以互相转换
...
static int ii = 0; // 其他使用 testFunc()的文件无法访问变量i
void testFunc1() { extern int ii; }
//**你同样可以声明函数为static**
///////////////////////////////////////
// 用户自定义类型和结构
///////////////////////////////////////
...
// 复制整个struct。
int areaP(const rect *r) { return r->width * r->height; }
///////////////////////////////////////
// 函数指针
///////////////////////////////////////
/*
