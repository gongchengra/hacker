...
function decode_morse($code) {
  return trim(str_replace(['   ',' ','^'], ['^','',' '],strtr($code,array_flip(get_morse()))));
}

$str = '.... . -.--   .--- ..- -.. .';
//echo decode_morse('.... . -.--   .--- ..- -.. .');
//echo decode_morse($str);
//echo strtr($str, array_flip(get_morse()));
echo str_replace(['   ',' ','^'],['^','', ' '], strtr($str, array_flip(get_morse())));
